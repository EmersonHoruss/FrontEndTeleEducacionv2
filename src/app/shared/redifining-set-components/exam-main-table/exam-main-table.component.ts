...
@Component({
  selector: 'app-exam-main-table',
  templateUrl: './exam-main-table.component.html',
  styleUrls: ['./exam-main-table.component.scss'],
})
export class ExamMainTableComponent implements OnInit {
